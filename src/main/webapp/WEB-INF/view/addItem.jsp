            ...
            <form action="item?action=add" method="post" id="addItemForm">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control" step="0.01" min="0" id="price" name="price" placeholder="0.00" required>
                    </div>
                    
                    <div class="form-group col-md-4">
                        <label for="stockQuantity">Stock Quantity</label>
                        <input type="number" class="form-control" min="0" id="stockQuantity" name="stockQuantity" placeholder="0" required>
                    </div>
                    
                    <div class="form-group col-md-4">
                        <label for="itemId">Item ID (Auto)</label>
                        <input type="text" class="form-control" id="itemId" name="itemId" placeholder="Auto-generated" disabled>
                    </div>
                </div>
